...
INSERT INTO nodes (topic_id, parent_id, version_id, label, emoji, color, summary, depth, sort_order, sources) VALUES
  -- Root (H1)
  ('a1000000-0000-0000-0000-000000000001', NULL, 'b1000000-0000-0000-0000-000000000001',
   'Surfing', '🏄', '#4F46E5',
...
-- Nuclear Power nodes
INSERT INTO nodes (topic_id, parent_id, version_id, label, emoji, color, summary, depth, sort_order, sources) VALUES
  ('a1000000-0000-0000-0000-000000000002', NULL, 'b1000000-0000-0000-0000-000000000002',
...
-- Jazz nodes
INSERT INTO nodes (topic_id, parent_id, version_id, label, emoji, color, summary, depth, sort_order, sources) VALUES
  ('a1000000-0000-0000-0000-000000000003', NULL, 'b1000000-0000-0000-0000-000000000003',
